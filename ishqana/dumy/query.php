...
header("Location: jobenquire.php");
exit();
...
$courseQuery = "SELECT DISTINCT applyfor FROM jobapply";
...
<option value="<?php echo $courseRow['applyfor']; ?>"

<?php 
if(isset($_GET['course']) && $_GET['course']==$courseRow['applyfor']){
echo "selected";
}
?>
