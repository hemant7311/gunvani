<?php
$activePage = 'news';
$pageTitle = 'Manage News Articles - Gunvani News Admin';
...
<div class="page-header">
    <div class="page-title-box">
        ...
        <p>View, edit, publish or delete news articles across all city channels.</p>
    </div>
    <div>
        <a href="add_news.php" class="btn btn-success px-4 py-2 font-weight-bold shadow-sm">
            <i class="fa-solid fa-plus me-2"></i>Add New Article
        </a>
    </div>
</div>
