...
if (isset($_POST['save'])) {
    ...
    $stmt = $pdo->prepare('INSERT INTO homepage_sections (title, subtitle, section_type, category_id, article_id, display_order) VALUES (?, ?, ?, ?, ?, ?)');
    $stmt->execute([$title, $subtitle, $type, $category_id ?: null, $article_id ?: null, $display_order]);
...
<div class="container py-5">
    ...
    <div class="card p-4 shadow-sm">
        <h2 class="mb-4">Add Homepage Section</h2>
        <form method="post">
            <div class="mb-3">
            ...
            <div class="mb-3" id="article-row" style="display:none;">
                ...
                <select name="article_id" class="form-control">
                    ...
                    <?php foreach ($articles as $article): ?>
                        <option value="<?= htmlspecialchars($article['id'], ENT_QUOTES, 'UTF-8') ?>"><?= htmlspecialchars($article['title'], ENT_QUOTES, 'UTF-8') ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="mb-3">
