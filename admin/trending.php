<?php
$activePage = 'trending';
$pageTitle = 'Manage Trending Stories - Gunvani News Admin';
...
<div class="page-header">
    <div class="page-title-box">
        <h1>Manage Trending Stories</h1>
        <p>View, edit, or delete published Trending Stories reports.</p>
    </div>
    <div>
        <a href="add_trending.php" class="btn btn-success px-4 py-2 font-weight-bold shadow-sm">
            <i class="fa-solid fa-fire text-danger me-2"></i>Add Trending Stories
        </a>
    </div>
</div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-btn-group justify-content-center">
                                    ...
                                    <a href="edit_trending.php?id=<?= $article['id'] ?>" class="btn-icon-action btn-edit" title="Edit Article" aria-label="Edit Article">
