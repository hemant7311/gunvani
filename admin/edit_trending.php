<?php
$activePage = 'trending';
$pageTitle = 'Edit Trending Story - Gunvani News Admin';
...
<div class="page-header">
    ...
    <div>
        <a href="trending.php" class="btn btn-outline-secondary">
        ...
        <div class="col-lg-8">
            <div class="admin-card mb-4">
                <div class="admin-card-header">
                    <h5><i class="fa-solid fa-pencil me-2 text-warning"></i>Edit Trending Story Details</h5>
                </div>
